...
int main() {
    ...
    // Display the initial position of the output file pointer
    cout << "Initial Output Position: " << file.tellp() << endl;

    // Seek to the 7th position from the beginning of the file
    file.seekp(7, ios::beg);

    // Display the updated position of the output file pointer
    cout << "Updated Output Position: " << file.tellp() << endl;

    // Display the initial position of the input file pointer
    cout << "Initial Input Position: " << file.tellg() << endl;

    // Seek to the 2nd position from the beginning of the file
    file.seekg(2, ios::beg);

    // Display the updated position of the input file pointer
    cout << "Updated Input Position: " << file.tellg() << endl;

    // Read and display the content from the current input position
    string content;
    getline(file, content);
    cout << "Read from Input Position: " << content << endl;
