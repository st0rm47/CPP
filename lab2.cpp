...
int main(){
    ...
    c3=c3.sum(c1,c2); //prints the value from function complex :: sum
    c3.showdata();  // function call  
    return 0;
}


/* Program to add 2 complex numbers using pass by reference */
#include<iostream>
using namespace std;
class complex{  //class
    private:
...
/* Program to add 2 complex numbers using Pointer */
#include<iostream>
using namespace std;
class complex{  //class
    private:
